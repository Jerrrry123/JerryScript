...
t(f('Forces you info the sky if you\'re in a vehicle.'), '如果您在载具内,强制您飞向高空.')
t(f('Anchor'), '锚')
t(f('Forces you info the ground if you\'re in a air born vehicle.'), '如果您在空中飞行的载具中,会强制您回到地面.')
t(f('Fake money'), '')
...
t(f('Just becurse every script has train options, I gotta have an anti train option.'), '只是因为每个脚本都有火车选项,我必须也有一个反火车选项.')
