...
t(f('Makes the minigun into a flamethrower.'), 'Minigun\'u alev makinesine dönüştürür')
...
t(f('Lowers the radio when you\'re not in first person mode.'), 'Birinci şahıs modunda olmadığınızda telsizi düşürür.')
